...
- Coverage additions: 25 cache-manager tests (was 21 → 23 + 2 round-2 FN1 pins + 1 round-2 dedup-preserve test), 34 manifest-db tests (was 23 → 32 + 2 round-2 FN2 pins), 19 workspace-scanner tests (was 14 + 5 v1.13 scan-memo tests), 4-test `status-tool.test.ts`, 2 round-2 FN3 pins on `files-uploader.test.ts`. Total suite: 695 passed | 9 skipped (was 663 | 9 in v1.12.2).
